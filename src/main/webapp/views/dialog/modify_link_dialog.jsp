                    ...
                    <div class="col-md-8">
                        <p class="text-center lead">
                            <small class="indicator" style="font-weight: bold" id="modifyLinkAsEdit"
                                   onclick="toggleDivState('chooseEditLink','chooseDeleteLink','modifyLinkAsEdit','modifyLinkAsDelete','modifyLinkErrorMsg','')"
                            >编辑
                            </small>&nbsp;&nbsp;<span class="vertical-line">|</span>&nbsp;&nbsp;<small
                                class="indicator" id="modifyLinkAsDelete"
                                onclick="toggleDivState('chooseDeleteLink','chooseEditLink','modifyLinkAsDelete','modifyLinkAsEdit','modifyLinkErrorMsg','')">
                            删除
                        </small>
                        </p>
